...
import 'package:play_pointz/screens/play/WebView/Awurudugames.dart';
...
import 'Controller/PlayMartController.dart';
import 'model/LiveMatchModel.dart';
                                                        ...
                                                        (context, index) =>
                                                            index == 1
                                                                ...
                                                                : Column(
                                                                    children: [
                                                                      /////////////////////////////////////////////////////////////////Lisna Gha/////////////////////////////////////////////////////////
                                                                      _list[0].ItemNameList[4] ==
                                                                              ""
                                                                          ? Container()
                                                                          : InkWell(
                                                                              onTap: () {
                                                                                Navigator.push(context, MaterialPageRoute(builder: (context) => Awurudugames()));
                                                                                // WebViewController
                                                                                //     controller =
                                                                                //     WebViewController()
                                                                                ...
                                                                                child: Container(
                                                                                  child: ClipRRect(
                                                                                    ...
                                                                                    child: CachedNetworkImage(
                                                                                      imageUrl: _list[0].ItemNameList[9], // Replace with your image URL
                                                                                      fit: BoxFit.cover,
                                                                                      placeholder: (context, url) => Center(child: CircularProgressIndicator()), // Optional placeholder widget while loading
                                                                                      errorWidget: (context, url, error) => Icon(Icons.error), // Optional error widget to display on image load failure
                                                                                    ),
                                                                                  ),
                                                                                  height: 120,
